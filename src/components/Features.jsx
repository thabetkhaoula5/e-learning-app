function Features() {
    ...
    return (
        <section className="relative flex flex-col lg:flex-row items-center justify-center gap-4 lg:gap-8 py-12 px-6 md:px-12">
            <div className="w-full lg:w-[48%] flex justify-center">
                <img src="\images\img-2.svg" alt="étudiante" className="w-full max-w-md lg:max-w-full" />
            </div>
            <div className="w-full lg:w-[45%] flex flex-col items-start justify-center">
                ...
                <div className="flex flex-col w-full space-y-4">
                    <div className="flex justify-start items-start gap-3">
                        <svg className="shrink-0 mt-1" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clipPath="url(#clip0_28_749)">
                            <mask id="mask0_28_749" style={{maskType: 'luminance'}} maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                            <path d="M24 0H0V24H24V0Z" fill="white"/>
                            </mask>
                            <g mask="url(#mask0_28_749)">
                            <path d="M12 2C6.49 2 2 6.49 2 12C2 17.51 6.49 22 12 22C17.51 22 22 17.51 22 12C22 6.49 17.51 2 12 2ZM16.78 9.7L11.11 15.37C10.97 15.51 10.78 15.59 10.58 15.59C10.38 15.59 10.19 15.51 10.05 15.37L7.22 12.54C6.93 12.25 6.93 11.77 7.22 11.48C7.51 11.19 7.99 11.19 8.28 11.48L10.58 13.78L15.72 8.64C16.01 8.35 16.49 8.35 16.78 8.64C17.07 8.93 17.07 9.4 16.78 9.7Z" fill="#23BDEE"/>
                            </g>
                            </g>
                            <defs>
