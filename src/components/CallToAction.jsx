    ...
    return (
        <section className="relative flex flex-col md:flex-row justify-center items-center px-12 pt-6 md:pt-8 md:pb-0 pb-6 mx-4 md:mx-10 lg:mx-20 my-8 rounded-2xl bg-linear-to-br from-background via-blue to-background shadow-xl shadow-black/10">
            ...
            <div className="flex flex-col gap-2 text-center md:text-left">
                ...
                <button className="bg-white/35 rounded-full py-2.5 px-6 md:px-8 mt-2 md:mt-3 text-darkBlue text-base md:text-lg lg:text-[18px] capitalize font-medium w-fit mx-auto md:mx-0 cursor-pointer hover:shadow-lg hover:shadow-white/10 hover:-translate-y-1.5 transition-all duration-500">
