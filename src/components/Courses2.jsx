            ...
            <div className="flex flex-col items-center justify-start w-full max-w-[990px] mx-auto gap-10">
                ...
                <div className="grid grid-cols-2 gap-[30px] w-[990px]">
                    ...
                    <div className="flex flex-col bg-white rounded-[20px] border border-[#25264199] w-[480px] h-[510px] overflow-hidden hover:shadow-xl hover:-translate-y-2 transition-all duration-500">
                        <div className="p-4">
                            <img src="\images\imge-7.svg" alt="Internet des Objets" className="w-full h-65 object-cover rounded-xl" />
                        </div>
                        <div className="px-5 pb-6 flex flex-col gap-2">
                            <h3 className="text-xl capitalize text-darkBlue font-semibold leading-snug">Internet Des Objets</h3>
                            <p className="text-darkBlue/60 text-sm font-normal">Développez des solutions connectées et programmez des objets intelligents pour l'IoT.</p>
                    ...
                    <div className="flex flex-col bg-white rounded-[20px] border border-[#25264199] w-[480px] h-[510px] overflow-hidden hover:shadow-xl hover:-translate-y-2 transition-all duration-500">
                        <div className="p-4">
                            <img src="\images\imge-8.svg" alt="Fondamentaux De la Cybersécurité" className="w-full h-65 object-cover rounded-xl" />
                        </div>
                        <div className="px-5 pb-6 flex flex-col gap-2">
                            <h3 className="text-xl capitalize text-darkBlue font-semibold leading-snug">Fondamentaux De la Cybersécurité</h3>
                            <p className="text-darkBlue/60 text-sm font-normal">Apprenez à protéger les systèmes informatiques contre les menaces et les cyberattaques.</p>
                    ...
                    {/* Card 3 - Gestion de BDD */}
                    <div className="flex flex-col bg-white rounded-[20px] border border-[#25264199] w-[480px] h-[510px] overflow-hidden hover:shadow-xl hover:-translate-y-2 transition-all duration-500">
                        <div className="p-4">
                            <img src="\images\imge-9.svg" alt="Gestion De Base De Données" className="w-full h-65 object-cover rounded-xl" />
                        </div>
                        <div className="px-5 pb-6 flex flex-col gap-2">
                            <h3 className="text-xl capitalize text-darkBlue font-semibold leading-snug">Gestion De Base De Données</h3>
                            <p className="text-darkBlue/60 text-sm font-normal">Maîtrisez la conception, l'optimisation et la gestion de bases de données relationnelles et NoSQL.</p>
                    ...
                    <div className="flex flex-col bg-white rounded-[20px] border border-[#25264199] w-[480px] h-[510px] overflow-hidden hover:shadow-xl hover:-translate-y-2 transition-all duration-500">
                        <div className="p-4">
                            <img src="\images\imge-10.svg" alt="Développement Blockchain" className="w-full h-65 object-cover rounded-xl" />
                        </div>
                        <div className="px-5 pb-6 flex flex-col gap-2">
                            <h3 className="text-xl capitalize text-darkBlue font-semibold leading-snug">Développement Blockchain</h3>
                            <p className="text-darkBlue/60 text-sm font-normal">Construisez des applications décentralisées et des smart contracts sur les principales blockchains.</p>
